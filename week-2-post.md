...
The system needs raw material to learn from. In aviation terms, this is every sensor reading, maintenance log, and flight record from your fleet. Quality matters. Poor data produces unreliable results. Autonomous data links to the aircraft systems transmits the data in a standard format with data entry errors, as was the case prior to the availability of digital data.    
